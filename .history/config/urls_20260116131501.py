...
from apps.accounts.views import login_view, logout_view, manager_dashboard, student_dashboard, lecturer_dashboard, cs_dashboard, coordinator_dashborad
...
urlpatterns = [
    ...
    path('dashboard/coordinator/', coordinator_dashborad, name='coordinator_dashborad'),
]
