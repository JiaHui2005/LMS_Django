...
urlpatterns = [
    ...
    #CRUD Class
    path('', class_views.class_list, name='class_list'),
    path('create/', class_views.class_create, name='class_create'),
    path('<int:class_id>/edit/', class_views.class_edit, name='class_edit'),
    path('<int:class_id>/deactivate/', class_views.class_deactivate, name='class_deactivate'),
]
